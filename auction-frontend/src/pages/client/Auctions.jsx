        ...
        {currentItems.map((auction, index) => (
          <div className="col-md-4" key={auction.id}>
            <div className="card h-100">
              <img src={auction.media?.[0]?.url || "/default-image.jpg"} className="card-img-top" alt={auction.title} style={{ height: '200px', objectFit: 'cover' }} />
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  Ends at: {formatDateToDisplay(auction.endTime)}<br />
                ...
                <div className="d-flex justify-content-between">
                  <button className="btn btn-primary" onClick={() => navigate(`/auctions/${auction.id}`)}>View</button>
